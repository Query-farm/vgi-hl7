# vgi-hl7 VGI worker — build, unit-test, and SQL E2E targets.
#
# Usage:
...
JAR_GLOB       = build/libs/vgi-hl7-*-all.jar
...
# Regenerate the committed SQL fixtures from the canonical message builders.
fixtures:
...
test-sql: build fixtures
	...
	echo "Worker JAR: $$JAR"; \
	VGI_HL7_WORKER="java -jar $$(pwd)/$$JAR" \
